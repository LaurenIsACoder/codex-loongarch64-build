...
Upstream Codex version: `0.142.0`  
Release tag: `v0.142.0-loongarch64.1`  
...
- upstream release tag: `rust-v0.142.0`
- CLI version: `codex-cli 0.142.0`
- target: `loongarch64-unknown-linux-gnu`

### Changes from v0.140.0-loongarch64.1

| Item | v0.140.0 | v0.142.0 |
|------|----------|----------|
| Upstream Codex | 0.140.0 | 0.142.0 |
| rusty_v8 | 149.2.0 | 149.2.0 (unchanged) |
| tokio-tungstenite | `132f5b39` | `0e5b2d73` |
| tungstenite | `9200079d` | `4fffad30` |

### Highlights

- Upgraded to upstream `codex-cli 0.142.0`
...
- 上游 release tag：`rust-v0.142.0`
- CLI 版本：`codex-cli 0.142.0`
- 目标架构：`loongarch64-unknown-linux-gnu`

### 相比 v0.140.0-loongarch64.1 的变化

| 项目 | v0.140.0 | v0.142.0 |
|------|----------|----------|
| 上游 Codex | 0.140.0 | 0.142.0 |
| rusty_v8 | 149.2.0 | 149.2.0（未变） |
| tokio-tungstenite | `132f5b39` | `0e5b2d73` |
| tungstenite | `9200079d` | `4fffad30` |

### 主要特点

- 升级至上游 `codex-cli 0.142.0`
